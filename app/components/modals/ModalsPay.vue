...
const paidMoney = () => {
  ...
  paidStore.SET_PAID_NOT_SELECT(query)
}
...
<template>
      <modalsBaseModal :show="modalStore.paidModal" title="Покупка билетов" @close="toggleModal" width="350px">
      <div class="modals__form">
        ...
        <div class="modals__footer"  v-if="balance > (film.price * film.selectedSeatCount)">
          ...
          <span @click="payCard">Оплатить баллами</span>
        </div>
      </div>
      </modalsBaseModal>
</template>
