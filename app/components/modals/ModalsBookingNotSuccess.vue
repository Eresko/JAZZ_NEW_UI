...
const toggleModal = () => {
  modalStore.TOGGLE_BOOKING_NOT_SUCESS_MODAL()
}
...
<template>
      <modalsBaseModal :show="modalStore.bookingNotSuccess" title="Выбранные места не забронированы." @close="toggleModal" width="370px">
      <div class="modals__form">
        <svg style="rotate: 180deg; margin-top: 10px" class="modal-success__ico" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
